...
class Dokumen_foto_model extends Model {
    ...
    {
    	$result = $this->query("SELECT a.autocode, a.`nama_media`, IF(b.autocode IS NULL, '', 'selected') AS pselct FROM ref_media  a  LEFT JOIN ( SELECT  autono, autocode, jenis_media FROM tbl_dokumen WHERE autono = $id) b ON b.`jenis_media` = a.`autocode` WHERE direktori = 'Image' ORDER BY a.nama_media ASC");
