...
class Dokumen_lisjarah_model extends Model {
    ...
    public function mget_video($request, $table, $primaryKey, $columns)

    {

        $result = $this->mgetvideo($request, $table, $primaryKey, $columns);
	...
	public function getfiles($request, $table, $primaryKey, $columns, $id, $y, $ftable)
	{
		
		$result = $this->getfile_disjarah($request, $table, $primaryKey, $columns, $id, $y, $ftable);
    ...
    {
    	$result = $this->query("SELECT autocode, nama_media FROM ref_media WHERE direktori = 'Video' ORDER BY nama_media ASC");
    ...
    {
    	$result = $this->query("SELECT a.autocode, a.`nama_media`, IF(b.autocode IS NULL, '', 'selected') AS pselct FROM ref_media  a  LEFT JOIN ( SELECT  autono, autocode, jenis_media FROM tbl_dokumen WHERE autono = $id) b ON b.`jenis_media` = a.`autocode` WHERE direktori = 'Video' ORDER BY a.nama_media ASC");
    ...
    public function mgetvideo ( $request, $table, $primaryKey, $columns)

    {
        ...
        $sJoin  = "LEFT JOIN ( SELECT parent_id, nama_file FROM vt_files GROUP BY parent_id) AS vt_files ON $table.`autono` = vt_files.`parent_id`";
