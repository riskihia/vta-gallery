...
class Dokumen_binfung extends Controller {
	...
	private $model      = "Dokumen_video_model";

	private $menu       = "Binfung";

	private $title      = "Data Dokumen";

	private $curl       = BASE_URL."dokumen_binfung";
...

	{
		...
		$template            = $this->loadView('dokumen_video_view');
...

	{
		...
		$template            = $this->loadView('dokumen_video_add');
...

	{
		...
		$template              = $this->loadView('dokumen_video_edit');
...

	{
		...
		if($x){
			...
			$this->redirect('dokumen_video/detail/'.$x);
...

	{
		...
		if($child){
			...
			$this->redirect('dokumen_video/detail/'.$child);
