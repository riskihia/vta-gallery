...
class Rekap_upload_dokumen_kategori extends Controller {

	private $table       = "tbl_dokumen";
	private $primaryKey  = "autono";
	private $model       = "Rekap_model"; # please write with no space
	private $title       = "Rekap Upload Dokumen per Jenis Kategori";
	private $menu        = "Rekap";
	private $curl        = BASE_URL."rekap_upload_dokumen_kategori";
	private $sQuery      = "SELECT COUNT(kd_kategori) AS jumlah, parent_id, kd_kategori, nama_kategori FROM tbl_dokumen_kategori a 
LEFT JOIN (SELECT autocode, nama_kategori FROM ref_kategori) AS b ON a.`kd_kategori` = b.autocode
...
ORDER BY jumlah DESC";
	...
	function index()
	{
		...
		$data['curl']        = $this->curl;
		$template            = $this->loadView('rekap_upload_dokumen_kategori');
	...
	function print_report()
     {
       ...
       // $pdf->Image(BASE_URL.'static/images/mabesad.jpg', 140, 3, 10);
        ...
        $pdf->Cell(120, 15, 'NAMA KATEGORI', 'LRT', 0, 'C');
