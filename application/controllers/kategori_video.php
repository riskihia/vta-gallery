...
class Kategori_video extends Controller {



	private $table      = "ref_kategori_video";

	private $primaryKey = "autono";

	private $model      = "Kategori_video_model";

	private $menu       = "Referensi";

	private $title      = "Kategori Video";

	private $curl       = BASE_URL."kategori_video";
...

	{
		...
		$template            = $this->loadView('kategori_video_view');
...

	{
		...
		$template            = $this->loadView('kategori_video_add');
...

	{
		...
		$template            = $this->loadView('kategori_video_edit');
...

	{
		...
		$data['autocode']     = $model->autocode($this->table, "CV-");	

		$result               = $model->msave($this->table, $data, $this->title);

		if($x){

			$this->redirect('kategori_video/detail/'.$x);

		} else {

			$this->redirect('kategori_video');
...

	{
		...
		if($child){
			...
			$this->redirect('kategori_video/detail/'.$child);
