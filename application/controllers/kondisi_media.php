...
class Kondisi_media extends Controller {



	private $table      = "ref_kondisi";

	private $primaryKey = "autono";

	private $model      = "Kondisi_media_model";

	private $menu       = "Referensi";

	private $title      = "Kondisi Media";

	private $curl       = BASE_URL."kondisi_media";
...

	{
		...
		$template            = $this->loadView('kondisi_media_view');
...

	{
		...
		$columns = array(
			...
			array( 'db' => 'nama_kondisi',  'dt' => 1 ),array( 'db' => 'keterangan',  'dt' => 2 ),
...

	{
		...
		$template            = $this->loadView('kondisi_media_add');
...

	{
		...
		$template            = $this->loadView('kondisi_media_edit');
...

	{
		...
		$data['nama_kondisi'] = htmlspecialchars($_REQUEST['nama_kondisi']) ;
		...
		if($x){
			...
			$this->redirect('kondisi_media/detail/'.$x);

		} else {

			$this->redirect('kondisi_media');
...

	{
		...
		if($child){
			...
			$this->redirect('kondisi_media/detail/'.$child);
