...
class Dokumen_museum extends Controller {
	...
	private $model      = "Dokumen_museum_model";

	private $menu       = "Transaksi";

	private $title      = "Data museum";

	private $curl       = BASE_URL."dokumen_museum";
...

	{
		...
		$template            = $this->loadView('dokumen_museum_view');
...

	{
		...
		$template            = $this->loadView('dokumen_museum_add');
...

	{
		...
		$template              = $this->loadView('dokumen_museum_edit');
...

	{
		...
		if($x){
			...
			$this->redirect('dokumen_museum/detail/'.$x);

		} else {

			$this->redirect('dokumen_museum');
...

	{
		...
		if($child){
			...
			$this->redirect('dokumen_museum/detail/'.$child);
