...
class Dokumen_tradisi extends Controller {



	private $table      = "tbl_dokumen_tradisi";

	private $primaryKey = "autono";

	private $model      = "Dokumen_tradisi_model";

	private $menu       = "Transaksi";

	private $title      = "Data tradisi";

	private $curl       = BASE_URL."dokumen_tradisi";
...

	{
		...
		$template            = $this->loadView('dokumen_tradisi_view');
...

	{
		...
		$template            = $this->loadView('dokumen_tradisi_add');
...

	{
		...
		$template              = $this->loadView('dokumen_tradisi_edit');
...

	{
		...
		if($x){
			...
			$this->redirect('dokumen_tradisi/detail/'.$x);

		} else {

			$this->redirect('dokumen_tradisi');
...

	{
		...
		if($child){
			...
			$this->redirect('dokumen_tradisi/detail/'.$child);
