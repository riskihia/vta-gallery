...
class Dokumen_perpustakaan extends Controller {



	private $table      = "tbl_dokumen_perpustakaan";

	private $primaryKey = "autono";

	private $model      = "Dokumen_perpustakaan_model";

	private $menu       = "Transaksi";

	private $title      = "Data Perpustakaan";

	private $curl       = BASE_URL."dokumen_perpustakaan";
...

	{
		...
		$template            = $this->loadView('dokumen_perpustakaan_view');
...

	{
		...
		$template            = $this->loadView('dokumen_perpustakaan_add');
...

	{
		...
		$template              = $this->loadView('dokumen_perpustakaan_edit');
...

	{
		...
		if($x){
			...
			$this->redirect('dokumen_perpustakaan/detail/'.$x);

		} else {

			$this->redirect('dokumen_perpustakaan');
...

	{
		...
		if($child){
			...
			$this->redirect('dokumen_perpustakaan/detail/'.$child);
