...
class Pengajuan_download extends Controller {
...

	{
		...
		$data['attch']       = $model->get_file_attachment(1);
		
		$template            = $this->loadView('pengajuan_download_view');
