						...
						<div class="thumbnail">
							...
							<div class="caption">
								<?php if(!empty($value['nama_project'])): ?>
									<div class="project-name">
										<h6 class="no-margin text-primary text-size-small">
											<strong>
												<a href="<?php echo BASE_URL."frontoffice/album_foto/".$idx; ?>" class="text-primary" title="<?php echo $value['nama_project']; ?>">
								...
								<div class="kegiatan-name">
									<h6 class="no-margin">
										<a href="<?php echo BASE_URL."frontoffice/album_foto/".$idx; ?>" class="text-default"><?php echo $string ?></a>
										<a href="<?php echo BASE_URL."frontoffice/album_foto/".$idx; ?>" class="text-muted"><i class="icon-three-bars pull-right"></i></a>
									</h6>
								</div>
