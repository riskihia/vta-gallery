                      ...
                      <form class="form-horizontal" action="<?php echo $data['curl']."/update/".$data['encode']."/".$data['child']; ?>" method="post">
                        <fieldset class="content-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-10">
                             <input type="text" class="form-control" name="nama_kamera" value="<?php echo $value['nama_kamera'] ?>" >
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="control-label col-lg-2">Merk</label>
                            <div class="col-lg-10">
                             <input type="text" class="form-control" name="merk" value="<?php echo $value['merk'] ?>" >
                            </div>
                          </div>
