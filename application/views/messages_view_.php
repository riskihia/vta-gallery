          ...
          "columns": [
              {
                ...
                "render": function ( data, type, row, meta ) {
                     ...
                     if(v[0] == "video"){
                      return '<video width="200" controls><source src="'+file+'" type="video/mp4"></video>';
                     } else {
              ...
              },
              {
                  ...
                  "render": function ( data, type, row, meta ) {
                     ...
                     return '<a href="'+file+'" target="_blank" class="btn-sx cyan" data-popup="tooltip" data-original-title="Download"><i class="icon-file-download" title="Download"></i></a>  ';
                       // var id = btoa(row[0]);
                       // return '<a href="'+url+'download/'+id+'" class="btn-sx cyan" data-popup="tooltip" data-original-title="Download"><i class="icon-file-download" title="Download"></i></a>  ';
                   }
              }
