                ...
                <!-- Basic datatable -->
                  ...
                  <div class="panel panel-flat">
                    ...
                    <div class="panel-heading">
                      ...
                      <h5 class="panel-title"><i class="icon-cabinet position-left"></i><strong>Koleksi</strong> Dokumen</h5>
                    ...
                    <div class="panel-body">
                        ...
                        <a href="<?php echo $data['curl'] ?>/add/<?php echo $data['encode']; ?>" class="btn btn-info btn-sx bg-teal"><i class="icon-plus-circle2 position-left"></i> Add Dokumen</a> 
                      ...
                      <thead>
                        ...
                        <tr>
                          <th class="text-center text-bold text-teal">No</th>
        									<th class="text-center text-bold text-teal">Judul Dokumen</th>
                          <th class="text-center text-bold text-teal">Tanggal</th>
                          <th class="text-center text-bold text-teal">Lokasi</th>
                           <th class="text-center text-bold text-teal">Operator</th>
                           
        									<th class="text-center text-bold text-teal">Dok.</th>    
                    ...
                    <div class="modal-dialog modal-full">
                      <div class="modal-content">
                        <div class="modal-header bg-teal">
                          ...
                          <h6 class="modal-title"><i class="icon-film4" title="Dokumen Video"></i>&nbsp; Dokumen</h6>
                        </div>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <button type="button" class="close" data-dismiss="modal">&times;</button>
                          <h6 class="modal-title text-bold"><i class="icon-clapboard" title="Upload video"></i>&nbsp; Upload Dokumen</h6>
                        </div>
                        <div class="modal-body">
                            <div class="form-group form-group-lg">
                              ...
                              <span class="help-block">Masukkan file dokumen yang akan di upload. Maksimal file yang di upload 10GB.</span>
                            </div>
                        </div>
                    </div>
                  </div>
...
<script type="text/javascript">
  ...
  $('.datatable').DataTable({
        ...
        "columns": [
            ...
            {"data": 8,width:'auto', "sortable": true},
            ...
            { 
                ...
                "sortable": false,
                  ...
                  "render": function ( data, type, row, meta ) {
                       if(row[4] == 1 ){
                        return "<a href=\"#\" onClick=\"showfiles(1,'"+row[0]+"','"+row[3]+"')\" class=\"btn-sx\" data-toggle=\"modal\" data-target=\"#modal_form\" title=\"View Dokumen\"><i class=\"icon-file-text3 text-grey-600\"></i></a> ";
