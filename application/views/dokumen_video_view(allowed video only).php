                      ...
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group form-group-lg">
                              <input type="file" class="file-input-video" name="file_video[]" data-show-upload="true" data-show-remove="false" multiple="true" data-remove-class="btn btn-default btn-sx" data-upload-class="btn btn-success btn-sx"  data-show-caption="false" data-show-preview="true" accept="video/mp4, video/avi, video/webp">
                              <span class="help-block">Hanya menerima tipe file <code>mp4</code>, <code>avi</code> dan <code>webp</code>. Maksimal file yang di upload 2048MB.</span>
                            </div>
                        </div>
                    </div>
                  </div>
...
<script type="text/javascript">
  ...
  var url_file = '<?php echo BASE_URL; ?>static/files/bahan/dokumen/';
    ...
    $('.file-input-video').fileinput({   
        ...
        maxFilesNum: 10,
        allowedFileExtensions: ["mp4", "avi", "webp"],
