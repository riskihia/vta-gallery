                      ...
                      <!-- Basic initialization -->
                        <div class="panel panel-flat">
                          <div class="panel-heading">
                            <h5 class="panel-title"><i class="icon-file-spreadsheet2 position-left"></i><strong> Laporan</strong> Upload Dokumen</h5>
                            <div class="heading-elements">
                              <ul class="icons-list">
                                <li><a href="<?php echo $data['curl']."/print_report"; ?>" target="_blank" class="btn btn-default btn-xs heading-btn"><i class="icon-printer position-left"></i> Print</a></li>
                              </ul>
                            </div>
                          </div>
