                              ...
                              <ul class="icons-list">
                                <li>
                                  <div class="form-group"  style="width: 300px; top: -13px;" >
                                      ...
                                      <select data-placeholder="Pilih jenis media" class="select-search" name="jenis_media" id="jenis_media" required="required"><i class="icon-arrow-left52 position-left"></i>
                                          <option></option>
                                          <option value="all">Semua</option>
                                          <?php foreach ($data['jenis'] as $key => $value) { 

                                            if($value[0] == 'MED-1'){ $selected = 'selected'; } else { $selected = ''; }
