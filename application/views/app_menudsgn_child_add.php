              ...
              <div class="page-header">
                ...
                <div class="breadcrumb-line">
                  <ul class="breadcrumb">
                    ...
                    <li><a href="<?php echo $data['curl'] ?>">Menu Designer</a></li>
              ...
              <div class="content">
                <div class="panel panel-flat">
                    <div class="panel-heading">
                      <h5 class="panel-title"><strong><?php echo $data['action'] ?></strong> Menu</h5>
                    ...
                    <div class="panel-body">
                      <form class="form-horizontal" action="<?php echo $data['curl']."savechild/".$data['project']."/".$data['encode']; ?>" method="post">
                        <fieldset class="content-group">

                          <div class="form-group">
                            <label class="control-label col-lg-2">Parent Menu</label>
                            <div class="col-lg-10">
                             <input type="text" class="form-control text-capitalize" name="parent_menu" value="<?php echo $data['modul'][5] ?>" readonly>
                             <input type="hidden" class="form-control text-capitalize" name="parent_id" value="<?php echo $data['modul'][0] ?>" readonly>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-10">
                             <textarea rows="5" cols="5" class="form-control" placeholder="" name="menu_desc"></textarea>
                            </div>
                          </div>
