                ...
                <!-- Basic datatable -->
                  ...
                  <div class="panel panel-flat">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="<?php echo $data['curl'] ?>/add/<?php echo $data['encode']; ?>" class="btn bg-teal btn-sx"><i class="icon-file-plus2 position-left"></i> Add Video/Foto</a>
                        ...
                        <tr>
                          ...
                          <th class="text-center text-bold text-teal">Tanggal</th>
                           <th class="text-center text-bold text-teal">Operator</th>
        									<th class="text-center text-bold text-teal">Video</th>    
                    ...
                    <div class="modal-dialog modal-full">
                      <div class="modal-content">
                        <div class="modal-header bg-teal">
                          ...
                          <h6 class="modal-title"><i class="icon-film4" title="Dokumen Video"></i>&nbsp; Video/Foto Final</h6>
                        </div>
                          ...
                          <table class="table table-striped" id="datafile1">
                              <thead>
                                <tr>
                                  ...
                                  <th class="text-center text-bold text-teal">Preview</th>
                                  <th class="text-center text-bold text-teal">Nama File</th>
                                  <th class="text-center text-bold text-teal">Tipe</th>
                                  <th class="text-center text-bold text-teal">Ukuran</th>
                                  <th class="text-center text-bold text-teal">Uploadby</th>
                                  <th class="text-center text-bold text-teal">Actions</th>
                                </tr>
                              </thead>
                          </table>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <button type="button" class="close" data-dismiss="modal">&times;</button>
                          <h6 class="modal-title text-bold"><i class="icon-clapboard" title="Upload video"></i>&nbsp; Upload video</h6>
                        </div>
                        <div class="modal-body">
                            <div class="form-group form-group-lg">
                              <input type="file" class="file-input-video" name="file_video[]" data-show-upload="true" data-show-remove="false" multiple="true" data-remove-class="btn btn-default btn-sx" data-upload-class="btn btn-success btn-sx"  data-show-caption="false" data-show-preview="true">
                              <span class="help-block">Masukkan file video yang akan di upload. Maksimal file yang di upload 10GB.</span>
                            </div>
                        </div>
                    </div>
                  </div>
        ...
        "columns": [
            ...
            { 
                ...
                "sortable": false,
                  ...
                  "render": function ( data, type, row, meta ) {
                       if(row[4] == 1 ){
                        return "<a href=\"#\" onClick=\"showfiles(1,'"+row[0]+"','"+row[3]+"')\" class=\"btn-sx\" data-toggle=\"modal\" data-target=\"#modal_form\" title=\"View Dokumen\"><i class=\"icon-film text-grey-600\"></i></a> ";
