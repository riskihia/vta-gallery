...
<head>
	...
	<title>Front Office xxx- Album Video</title>
		...
		<div class="page-header-content">
			<div class="page-title">
				...
				<ul class="breadcrumb breadcrumb-caret position-right">
					...
					<li><a href="<?php echo BASE_URL."frontoffice/gallery_video/"; ?>">Gallery Video</a></li>
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<div class="info-item info">
									<div class="media">
										<div class="media-left">
											<i class="icon-clapboard-play text-info"></i>
										</div>
										<div class="media-body">
											<div class="text-muted text-size-small">Total Video</div>
											<div class="text-semibold"><span class="label label-success"><?php echo count($data['aadata']); ?> Video</span></div>
										</div>
									</div>
								</div>
							</div>
