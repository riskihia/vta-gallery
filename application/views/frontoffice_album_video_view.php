	...
	<div class="page-header">
		<div class="page-header-content">
			<div class="page-title">
				<h4>
					<a href="<?php echo BASE_URL.'frontoffice/pencarian'; ?>"><i class="icon-arrow-left52 position-left"></i></a> <span class="text-semibold">Gallery Video</span> - <?php echo $data['info']['nama_kegiatan']?> 
