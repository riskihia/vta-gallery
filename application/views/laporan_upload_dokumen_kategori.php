                        ...
                        <div class="panel panel-flat">
                          <div class="panel-heading">
                            ...
                            <div class="heading-elements">
                              <ul class="icons-list">
                                <li>
                                  <div class="form-group"  style="width: 300px; top: -13px;" >
   
                                      <select data-placeholder="Pilih kategori" class="select-search" name="kategori" id="kategori" required="required"><i class="icon-arrow-left52 position-left"></i>
                                          <option></option>
                                          <option value="all">Semua</option>
                                          <?php foreach ($data['jenis'] as $key => $value) { 

                                            if($value[0] == 'CAT-1'){ $selected = 'selected'; } else { $selected = ''; }
                          ...
                          <table class="table datatable-laporan table-striped">
                            <thead>
                              <tr>
                                ...
                                <th class="center text-bold">Kegiatan</th>
                              </tr>
                            </thead>
                          </table>
                        </div>
  ...
  function getdata(i){
    $('.datatable-laporan').DataTable({
        ...
        "columns": [
            ...
            {"data": 4,width:'auto', sortable: false,},
            {"data": 3,width:'auto', sortable: false, className: 'text-center text-nowrap'},
