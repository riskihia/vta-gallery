				...
				<form class="form-horizontal" action="<?php echo $data['curl']."save"; ?>" method="post">
					 ...
					 <fieldset class="content-group">
						...
						<div class="form-group">
							...
							<div class="col-lg-10">
								<input type="text" name="nama_jabatan" class="form-control text-capitalize required" placeholder="Nama" required="required">
							</div>
						</div>
                    ...
                    <div class="col-lg-10">
                      <select data-placeholder="Pilih korps" class="select" name="korps">
						...
						<div class="text-right">
							...
							<button type="submit" class="btn btn-primary">Submit <i class="icon-circle-right2 position-left"></i></button>
						</div>	
