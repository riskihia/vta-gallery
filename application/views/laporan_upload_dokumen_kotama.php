                              ...
                              <ul class="icons-list">
                                <li>
                                  <div class="form-group"  style="width: 300px; top: -13px;" >
                                      ...
                                      <select data-placeholder="Pilih Satker" class="select-search" name="satker" id="satker" required="required"><i class="icon-arrow-left52 position-left"></i>
                                          <option></option>
                          ...
                          <table class="table datatable-laporan table-striped">
                            <thead>
                              <tr>
                                ...
                                <th class="center text-bold">Satker</th>
                              </tr>
                            </thead>
                          </table>
                        </div>
  ...
  function getdata(i){
    $('.datatable-laporan').DataTable({
        ...
        "columns": [
            ...
            {"data": 3,width:'auto', sortable: false, className: 'text-left text-nowrap'}
        ],
        buttons: {            
            dom: {
                button: {
