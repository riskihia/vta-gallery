                      ...
                      <form class="form-horizontal" action="<?php echo $data['curl']."/update/".$data['encode']."/".$data['child']; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <fieldset class="content-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-10">
                              <select data-placeholder="Pilih Klasifikasi" class="select"  name="kategori_video" required="required">
                                  <option></option>
                                  <?php foreach ($data['kategori_video'] as $key => $klas) { echo "<option value=\"".$klas[0]."\" ".$klas[2].">".$klas[1]."</option>"."\n";} ?>
                              </select>
                              <span class="help-block red"><code>* Wajib diisi</code></span>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-10">
                              <select data-placeholder="Pilih Media" class="select"  name="jenis_media" required="required">
                                  <option></option>
                                  <?php foreach ($data['media'] as $key => $value) { echo "<option value=\"".$value[0]."\" ".$value[2].">".$value[1]."</option>"."\n";} ?>
                              </select>
                              <span class="help-block red"><code>* Wajib diisi</code></span>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-10">
                             <select data-placeholder="Pilih provinsi / kota" class="select" multiple="multiple" name="provinsi[]" >
                                  <?php
                                    ...
                                    for ($i=0; $i < $jp; $i++) { 
                                      ...
                                      echo "<optgroup label=\"".$data['provinsi'][$i]['provinsi']."\">";
                                        for ($n=0; $n < $jk; $n++) { 
                                          echo "<option value=\"".$data['provinsi'][$i]['kabupaten'][$n]['kode']."\" ".ucfirst($data['provinsi'][$i]['kabupaten'][$n]['pselct']).">".ucfirst($data['provinsi'][$i]['kabupaten'][$n]['kabupaten'])."</option>"."\n";
                                        }
                                      echo "</optgroup>"."\n";
                                    }
                                  ?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-10">
                             <input type="text" class="form-control" name="fotografer" value="<?php echo $val['fotografer'] ?>">
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-10">
                              <input type="file" class="file-input" multiple="multiple" name="file_dokumen[]" data-show-upload="false" data-show-caption="true" data-show-preview="false" accept="videp/mpg, videp/mpeg, videp/mp4">
                            </div>
                          </div> 
                          ...
                          <div class="form-group">
                            ...
                            <?php foreach ($data['attch'] as $key => $attch) { ?>
                             ...
                             <div class="col-lg-2 col-sm-6" style="height: 200px">
                                <div class="thumbnail">
                                  <div class="thumb">
                                    ...
                                    if($tipe['0']== 'video'){ 
                                      ...
                                      echo "<img src=\"".BASE_URL."static/images/1485477041-play_78590.png"."\" >";
                                      // $ext = explode(".", $attch['nama_file']);
                                      // $newfile = $ext[0].".jpg";
                                      // echo '<img src="'.BASE_URL."static/files/".$attch['dir']."/".$attch['kode_parent']."/".$attch['subdir']."/".$newfile.'" class=\"col-lg-2 col-sm-6\" alt="">';  
                                    }  else { 
                                      echo '<img src="'.BASE_URL."static/files/bahan/".$attch['dir']."/".$attch['kode_parent']."/".$attch['subdir']."/".$attch['nama_file'].'" class=\"col-lg-2 col-sm-6\" alt="">';  
                                    } 
                                    ?>
                                    ...
                                    <div class="caption-overflow">
                                      <span>
                                        <?php 
                                        if($tipe['0']== 'video'){
                                          echo '<a href="'.BASE_URL."static/files/bahan/".$attch['dir']."/".$attch['kode_parent']."/".$attch['subdir']."/".$attch['nama_file'].'" data-popup="lightbox" rel="gallery" target="_blank" class="btn border-white text-white btn-flat btn-icon btn-rounded"><i class="icon-eye"></i></a>';  
                                        }  else { 
                                          echo '<a href="'.BASE_URL."static/files/bahan/".$attch['dir']."/".$attch['kode_parent']."/".$attch['subdir']."/".$attch['nama_file'].'" data-popup="lightbox" rel="gallery" target="_blank" class="btn border-white text-white btn-flat btn-icon btn-rounded"><i class="icon-eye"></i></a>';  
                                        }  
                                        ?>
