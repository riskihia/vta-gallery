                      ...
                      <form class="form-horizontal" action="<?php echo $data['curl']."/update/".$data['encode']."/".$data['child']; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <fieldset class="content-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-10">
                              <input type="file" class="file-input" multiple="multiple" name="file_dokumen[]" data-show-upload="false" data-show-caption="true" data-show-preview="true" accept="image/jpg, image/jpeg, image/png">
                            </div>
                          </div> 
                                ...
                                <div class="thumbnail">
                                  <div class="thumb">
                                    ...
                                    <?php 
                                     ...
                                     echo '<img src="'.$fileshow.'" class=\"col-lg-2 col-sm-6\" alt="">';  
