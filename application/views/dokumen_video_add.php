                    ...
                    <div class="panel-body">
                      ...
                      <form class="form-horizontal" action="<?php echo $data['curl']."/save/".$data['encode']; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <fieldset class="content-group">
                            ...
                            <label class="control-label col-lg-2">Judul Dokumen</label>
                            <div class="col-lg-10">
                          ...
                          <div class="form-group">
                            <label class="control-label col-lg-2">Kategori Dok. Utama</label>
                            <div class="col-lg-10">
                              <select  class="select" data-placeholder="Pilih kategori"  name="kategori[]" >
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-10">
                              <select  class="select" data-placeholder="Pilih jenis"  name="" >
                                  <optgroup label="Terbuka">
                                  <option>Biasa</option>
                                  </optgroup>
                                  <optgroup label="Tertutup">
                          ...
                          <div class="form-group">
                            <label class="control-label col-lg-2">Sifat Dokumen </label>
                            <div class="col-lg-10">
                              <select  class="select" data-placeholder="Pilih sifat"  name="" >
                          ...
                          <div class="form-group">
                            <label class="control-label col-lg-2">Kategori Sejarah </label>
                            <div class="col-lg-10">
                              <select  class="select" data-placeholder="Pilih kategori sejarah"  name="" >
                                  
                                  <option>Sejarah Satuan</option>
                                  <option>Sejarah Biografi</option>
                                  <option>Sejarah Peristiwa</option>
                              </select>
                            </div>
                          </div>

                          <div class="form-group">
                            <label class="control-label col-lg-2">Sub Kategori Sejarah </label>
                            <div class="col-lg-10">
                              <select  class="select" data-placeholder="Pilih sub kategori sejarah"  name="" >
                                  
                                  <option>Perang Kemerdekaan</option>
                                  <option>Operasi Penumpasan</option>
                                  <option>OMSP</option>
                                  <option>IST (Ihtisar Sejarah Tahunan)</option>
                                  <option>Bujuk Pedoman</option>
                              </select>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-10">
                              <input type="file" class="file-input" multiple="multiple" name="file_dokumen[]" required="required" data-show-upload="false" data-show-caption="true" data-show-preview="true" accept="video/mpg, video/mpeg, video/mp4, video/avi, application/pdf, image/jpg, image/png, image/jpeg">
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-10 checkbox checkbox-switchery">
                                <input type="checkbox" class="switchery" data-switchery="true" checked name="complete"> 
                             </div>
                          </div>
