                    ...
                    <div class="panel-body">
                      <form class="form-horizontal" action="<?php echo $data['curl']."save"; ?>" method="post">
                        <fieldset class="content-group">
                            ...
                            <div class="col-lg-10">
                             <input type="text" class="form-control" name="kd_prov" >
                            </div>
                          </div>
                            ...
                            <div class="col-lg-10">
                             <input type="text" class="form-control" name="kd_kab" >
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-10">
                             <input type="text" class="form-control" name="kor_long" >
                            </div>
                          </div>
                            ...
                            <div class="col-lg-10">
                             <input type="text" class="form-control" name="kor_lat" >
                            </div>
                          </div>
