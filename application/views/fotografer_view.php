                ...
                <!-- Basic datatable -->
                  <div class="panel panel-flat">
                    ...
                    <table class="table datatable table-striped">
                      <thead>
                        <tr>
                          <th class="text-center text-bold text-teal">Nama Personel</th>
                          <th class="text-center text-bold text-teal">NRP</th>
                          <th class="text-center text-bold text-teal">Pangkat</th>
                          <th class="text-center text-bold text-teal">Jabatan</th>
                          <th class="text-center text-bold text-teal">JKel</th>
