              ...
              <div class="content">
                <div class="panel panel-flat">
                    ...
                    <div class="panel-body">
                      <form class="form-horizontal" action="<?php echo $data['curl']."updatechild/".$data['encode']; ?>" method="post">
                                  ...
                                  <?php
                                    ...
                                    for ($i=0; $i < $jp; $i++) { 
                                      ...
                                      echo "<optgroup label=\"".$data['pangkat'][$i]['milpnsval']."\" class=\"text-size-lg\">";
                                        for ($n=0; $n < $jk; $n++) { 
                                          echo "<option value=\"".$data['pangkat'][$i]['pangkat'][$n]['kd_pangkat']."\" ".$data['pangkat'][$i]['pangkat'][$n]['pselect'].">".ucfirst($data['pangkat'][$i]['pangkat'][$n]['nm_pangkat'])."</option>"."\n";
                                        }
                                      echo "</optgroup>"."\n";
                                    }
                                  ?>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-10">
                              <select data-placeholder="Pilih korps" class="select" name="korps">
                                  <option></option>
                                  <?php foreach ($data['korps'] as $key => $korps) { echo "<option value=\"".$korps[0]."\" ".$korps[2].">".$korps[0]."</option>"."\n";} ?>
                              </select>
                            </div>
                          </div>
